    ...
    },
    {
      $lookup: {
        ...
        pipeline: [
          ...
          // we can go with this much pipeline but we are goin things simpler for fronted bcz we are getting an array but now it will get object
          {
            $addFields: {
              owner: {
                $first: "$owner",
